...
/ip/firewall/filter/add chain="forward" comment="auto-http-e621dumper-default" dst-address=10.2.11.18 dst-port=80 protocol=tcp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-http-e621dumper-default" dst-address=fd2c:f4cb:63be:3::b12 dst-port=80 protocol=tcp action=accept
/ip/firewall/filter/add chain="forward" comment="auto-https-e621dumper-default" dst-address=10.2.11.18 dst-port=443 protocol=tcp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-https-e621dumper-default" dst-address=fd2c:f4cb:63be:3::b12 dst-port=443 protocol=tcp action=accept
/ip/firewall/filter/add chain="forward" comment="auto-quic-e621dumper-default" dst-address=10.2.11.18 dst-port=443 protocol=udp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-quic-e621dumper-default" dst-address=fd2c:f4cb:63be:3::b12 dst-port=443 protocol=udp action=accept
/ip/firewall/filter/add chain="forward" comment="auto-http-fadumper-default" dst-address=10.2.11.19 dst-port=80 protocol=tcp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-http-fadumper-default" dst-address=fd2c:f4cb:63be:3::b13 dst-port=80 protocol=tcp action=accept
/ip/firewall/filter/add chain="forward" comment="auto-https-fadumper-default" dst-address=10.2.11.19 dst-port=443 protocol=tcp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-https-fadumper-default" dst-address=fd2c:f4cb:63be:3::b13 dst-port=443 protocol=tcp action=accept
/ip/firewall/filter/add chain="forward" comment="auto-quic-fadumper-default" dst-address=10.2.11.19 dst-port=443 protocol=udp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-quic-fadumper-default" dst-address=fd2c:f4cb:63be:3::b13 dst-port=443 protocol=udp action=accept
...
/ipv6/firewall/filter/add chain="forward" comment="auto-https-mirror-default" dst-address=fd2c:f4cb:63be:3::b11 dst-port=444 protocol=tcp action=accept
/ip/firewall/filter/add chain="forward" comment="auto-quic-mirror-default" dst-address=10.2.11.17 dst-port=443 protocol=udp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-quic-mirror-default" dst-address=fd2c:f4cb:63be:3::b11 dst-port=443 protocol=udp action=accept
...
/ip/firewall/filter/add chain="forward" comment="auto-http-git-default" dst-address=10.2.11.13 dst-port=80 protocol=tcp action=accept
/ipv6/firewall/filter/add chain="forward" comment="auto-http-git-default" dst-address=fd2c:f4cb:63be:3::b0d dst-port=80 protocol=tcp action=accept
/ip/firewall/filter/add chain="forward" comment="auto-https-git-default" dst-address=10.2.11.13 dst-port=443 protocol=tcp action=accept
